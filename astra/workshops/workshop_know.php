...
$sql = "select * from workfun where ID=$id"; 
...
<img alt="image" class="img-responsive hello" style="float:left; margin-left:20px; width:300px; heigth: 100px;" src="Imgi/<?php echo $row["Image"]; ?> ">
<?php //echo '<img src="data:image;base64,'.base64_encode($row['Image']).'" alt="image" style="float:left; margin-left:20px; width:400px; heigth: 100px;">'; ?>

<?php 
$q=$row['Name'];
$query="Select count(*)  from workshop where InterestedWorkshop='$q' AND Partcipated=1 ";
...
<?php  if ($f >0) {?>
<center>
<form action='workshop_enroll_form.php' method="post">
