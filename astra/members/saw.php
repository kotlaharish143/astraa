...
$day2 = date('Y-m-d', $day1);
  ...
  if (isset($_POST['uploadx'])) {
	...
	$etime= $_POST['etime'];
  	...
  	$sql = "INSERT INTO fun (Name,Branch,Image,Description,Organisers,Date,stime,etime) VALUES ('$eventnamex','$branchname','$imagex','$image_textx','$Organisers','$day2','$stime','$etime')";
  	// execute query
...
<div class="navbars">
  ...
  <a href="#"class="active">Add Workshops</a>
