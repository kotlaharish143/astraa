...
<div class="navbar">
  ...
  <a href="#" class="active">Intern Applications</a>
  <a href="fea.php" >Workshop Applications</a>
  <a href="fae.php"  >Add Job</a>
  <a href="faw.php">Add Intern</a>
...
<form id="myform" method="POST">
 ...
 <input style="padding:5px;width:200px;" type="text" name="third" id="s2" class="" value="" placeholder="Job Name" >
